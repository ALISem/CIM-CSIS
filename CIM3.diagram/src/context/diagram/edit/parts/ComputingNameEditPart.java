 ...
 * @generated
 */
public class ComputingNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ComputingNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Computing_2010, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ComputingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
