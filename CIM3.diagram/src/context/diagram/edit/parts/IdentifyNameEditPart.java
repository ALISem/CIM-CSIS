 ...
 * @generated
 */
public class IdentifyNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Identify_2002, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.IdentifyNameEditPart.VISUAL_ID));
		}
		return parser;
	}
