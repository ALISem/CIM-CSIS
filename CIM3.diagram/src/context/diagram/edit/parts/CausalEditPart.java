...
import context.diagram.edit.policies.CausalItemSemanticEditPolicy;

/**
 * @generated
 */
public class CausalEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	* @generated
	*/
	public CausalEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new CausalItemSemanticEditPolicy());
	}
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CausalNameEditPart) {
			((CausalNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureCausalNameFigure());
			return true;
		}
		return false;
	}
