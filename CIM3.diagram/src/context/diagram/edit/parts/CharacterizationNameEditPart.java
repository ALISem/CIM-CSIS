 ...
 * @generated
 */
public class CharacterizationNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CIM3VisualIDRegistry.getType(context.diagram.edit.parts.CharacterizationNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public CharacterizationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Characterization_4006, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.CharacterizationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
