 ...
 * @generated
 */
public class PreferenceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PreferenceNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Preference_2008, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.PreferenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
