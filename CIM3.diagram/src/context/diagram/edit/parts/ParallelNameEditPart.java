 ...
 * @generated
 */
public class ParallelNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ParallelNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ParallelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Parallel_4003, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ParallelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
