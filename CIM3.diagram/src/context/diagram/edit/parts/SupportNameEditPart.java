 ...
 * @generated
 */
public class SupportNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CIM3VisualIDRegistry.getType(context.diagram.edit.parts.SupportNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Support_4013, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.SupportNameEditPart.VISUAL_ID));
		}
		return parser;
	}
