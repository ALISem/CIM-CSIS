 ...
 * @generated
 */
public class CompositeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Composite_2016, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.CompositeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
