 ...
 * @generated
 */
public class CurrentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CurrentNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Current_2003, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.CurrentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
