 ...
 * @generated
 */
public class FixedNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FixedNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Fixed_2015, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.FixedNameEditPart.VISUAL_ID));
		}
		return parser;
	}
