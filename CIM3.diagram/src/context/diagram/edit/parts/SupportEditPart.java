...
import context.diagram.edit.policies.SupportItemSemanticEditPolicy;

/**
 * @generated
 */
public class SupportEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SupportNameEditPart) {
			((SupportNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureSupportNameFigure());
			return true;
		}
		return false;
	}
