 ...
 * @generated
 */
public class LocationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Location_2017, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.LocationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
