...
import context.diagram.edit.policies.CIM3TextSelectionEditPolicy;
 ...
 * @generated
 */
public class SensedNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CIM3VisualIDRegistry.getType(context.diagram.edit.parts.SensedNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public SensedNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new CIM3TextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return CIM3ElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Sensed_4012, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.SensedNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, CIM3EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
