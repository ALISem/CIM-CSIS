 ...
 * @generated
 */
public class SocialNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SocialNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Social_2004, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.SocialNameEditPart.VISUAL_ID));
		}
		return parser;
	}
