 ...
 * @generated
 */
public class ProfiledNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ProfiledNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ProfiledNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Profiled_4005, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ProfiledNameEditPart.VISUAL_ID));
		}
		return parser;
	}
