 ...
 * @generated
 */
public class FocusFocalElementEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FocusFocalElementEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Focus_2014, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.FocusFocalElementEditPart.VISUAL_ID));
		}
		return parser;
	}
