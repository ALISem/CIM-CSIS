 ...
 * @generated
 */
public class RefinementTypeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RefinementTypeEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Refinement_2007, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.RefinementTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null, CIM3EditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
