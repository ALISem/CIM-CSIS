 ...
 * @generated
 */
public class StaticNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CIM3VisualIDRegistry.getType(context.diagram.edit.parts.StaticNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public StaticNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Static_4011, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.StaticNameEditPart.VISUAL_ID));
		}
		return parser;
	}
