 ...
 * @generated
 */
public class PastNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PastNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Past_2006, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.PastNameEditPart.VISUAL_ID));
		}
		return parser;
	}
