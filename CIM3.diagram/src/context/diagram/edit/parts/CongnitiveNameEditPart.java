 ...
 * @generated
 */
public class CongnitiveNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CongnitiveNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Congnitive_2001, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.CongnitiveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
