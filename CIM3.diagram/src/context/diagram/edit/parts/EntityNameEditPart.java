...
public class EntityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Entity_2009, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.EntityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
