 ...
 * @generated
 */
public class FutureNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FutureNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Future_2011, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.FutureNameEditPart.VISUAL_ID));
		}
		return parser;
	}
