 ...
 * @generated
 */
public class CausalNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CIM3VisualIDRegistry.getType(context.diagram.edit.parts.CausalNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public CausalNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Causal_4007, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.CausalNameEditPart.VISUAL_ID));
		}
		return parser;
	}
