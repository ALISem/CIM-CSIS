 ...
 * @generated
 */
public class DerivedNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(CIM3VisualIDRegistry.getType(context.diagram.edit.parts.DerivedNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Derived_4010, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.DerivedNameEditPart.VISUAL_ID));
		}
		return parser;
	}
