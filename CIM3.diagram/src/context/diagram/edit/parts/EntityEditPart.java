...
import context.diagram.edit.policies.EntityItemSemanticEditPolicy;
...
public class EntityEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CIM3VisualIDRegistry.getType(EntityNameEditPart.VISUAL_ID));
	}
	...
	public class EntityFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureEntityTypeFigure;
		...
		private void createContents() {
			...
			fFigureEntityTypeFigure = new WrappingLabel();

			fFigureEntityTypeFigure.setText("<...>");

			this.add(fFigureEntityTypeFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureEntityTypeFigure() {
			return fFigureEntityTypeFigure;
		}
