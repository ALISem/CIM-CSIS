...
public class ActivityNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Activity_2005, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ActivityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
