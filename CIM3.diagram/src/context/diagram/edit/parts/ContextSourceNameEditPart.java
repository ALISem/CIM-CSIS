 ...
 * @generated
 */
public class ContextSourceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContextSourceNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.ContextSource_2013, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ContextSourceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
