 ...
 * @generated
 */
public class RelevanceArgumentEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CIM3VisualIDRegistry.getType(context.diagram.edit.parts.RelevanceArgumentEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public RelevanceArgumentEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Relevance_4015, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.RelevanceArgumentEditPart.VISUAL_ID));
		}
		return parser;
	}
