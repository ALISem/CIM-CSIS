 ...
 * @generated
 */
public class ConflictNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ConflictNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ConflictNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Conflict_4016, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ConflictNameEditPart.VISUAL_ID));
		}
		return parser;
	}
