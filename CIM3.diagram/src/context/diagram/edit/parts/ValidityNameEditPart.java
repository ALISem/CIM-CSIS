 ...
 * @generated
 */
public class ValidityNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ValidityNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ValidityNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Validity_4009, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.ValidityNameEditPart.VISUAL_ID));
		}
		return parser;
	}
