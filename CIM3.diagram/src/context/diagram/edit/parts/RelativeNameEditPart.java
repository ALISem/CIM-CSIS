 ...
 * @generated
 */
public class RelativeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RelativeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CIM3ParserProvider.getParser(CIM3ElementTypes.Relative_2012, getParserElement(),
					CIM3VisualIDRegistry.getType(context.diagram.edit.parts.RelativeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
