 ...
 * @generated
 */
public class RefinementItemSemanticEditPolicy extends CIM3BaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public RefinementItemSemanticEditPolicy() {
		super(CIM3ElementTypes.Refinement_2007);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CIM3VisualIDRegistry.getVisualID(incomingLink) == ContextElementRefinementEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CIM3VisualIDRegistry.getVisualID(outgoingLink) == RefinementRefiningcontextsEditPart.VISUAL_ID) {
