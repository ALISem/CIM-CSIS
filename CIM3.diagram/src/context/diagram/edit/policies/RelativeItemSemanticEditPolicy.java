 ...
 * @generated
 */
public class RelativeItemSemanticEditPolicy extends CIM3BaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public RelativeItemSemanticEditPolicy() {
		super(CIM3ElementTypes.Relative_2012);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CIM3VisualIDRegistry.getVisualID(outgoingLink) == ValidityEditPart.VISUAL_ID) {
