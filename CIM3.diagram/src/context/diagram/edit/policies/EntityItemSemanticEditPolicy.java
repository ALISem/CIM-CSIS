 ...
 * @generated
 */
public class EntityItemSemanticEditPolicy extends CIM3BaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public EntityItemSemanticEditPolicy() {
		super(CIM3ElementTypes.Entity_2009);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CIM3VisualIDRegistry.getVisualID(incomingLink) == CharacterizationEditPart.VISUAL_ID) {
