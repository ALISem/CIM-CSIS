 ...
 * @generated
 */
public class FocusItemSemanticEditPolicy extends CIM3BaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public FocusItemSemanticEditPolicy() {
		super(CIM3ElementTypes.Focus_2014);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CIM3VisualIDRegistry.getVisualID(incomingLink) == RelevanceEditPart.VISUAL_ID) {
