 ...
 * @generated
 */
public class SupportReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public SupportReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Support) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints().canExistSupport_4013(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ContextModel container = (ContextModel) getLink().eContainer();
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints().canExistSupport_4013(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected Support getLink() {
		return (Support) getElementToEdit();
	}
