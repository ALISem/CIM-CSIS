 ...
 * @generated
 */
public class ProfiledReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ProfiledReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Profiled) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints().canExistProfiled_4005(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ContextModel container = (ContextModel) getLink().eContainer();
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints().canExistProfiled_4005(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected Profiled getLink() {
		return (Profiled) getElementToEdit();
	}
