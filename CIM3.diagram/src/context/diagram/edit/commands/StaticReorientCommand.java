 ...
 * @generated
 */
public class StaticReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public StaticReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Static) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints().canExistStatic_4011(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ContextModel container = (ContextModel) getLink().eContainer();
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints().canExistStatic_4011(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected Static getLink() {
		return (Static) getElementToEdit();
	}
