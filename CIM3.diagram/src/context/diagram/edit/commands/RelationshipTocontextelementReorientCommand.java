 ...
 * @generated
 */
public class RelationshipTocontextelementReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RelationshipTocontextelementReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRelationshipTocontextelement_4018(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRelationshipTocontextelement_4018(getOldSource(), getNewTarget());
	}
