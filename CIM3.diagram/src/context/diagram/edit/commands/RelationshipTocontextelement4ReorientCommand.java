 ...
 * @generated
 */
public class RelationshipTocontextelement4ReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RelationshipTocontextelement4ReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRelationshipTocontextelement_4021(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRelationshipTocontextelement_4021(getOldSource(), getNewTarget());
	}
