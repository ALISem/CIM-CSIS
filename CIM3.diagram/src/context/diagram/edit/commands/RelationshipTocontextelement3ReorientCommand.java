 ...
 * @generated
 */
public class RelationshipTocontextelement3ReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RelationshipTocontextelement3ReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRelationshipTocontextelement_4020(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRelationshipTocontextelement_4020(getOldSource(), getNewTarget());
	}
