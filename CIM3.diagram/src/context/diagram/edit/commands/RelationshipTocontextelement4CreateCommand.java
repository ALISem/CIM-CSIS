 ...
 * @generated
 */
public class RelationshipTocontextelement4CreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public RelationshipTocontextelement4CreateCommand(CreateRelationshipRequest request, EObject source,
			EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRelationshipTocontextelement_4021(getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setTocontextelement(getTarget());
		}
