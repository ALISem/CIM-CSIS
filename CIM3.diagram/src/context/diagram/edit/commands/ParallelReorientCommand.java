 ...
 * @generated
 */
public class ParallelReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ParallelReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Parallel) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints().canExistParallel_4003(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		ContextModel container = (ContextModel) getLink().eContainer();
		return CIM3BaseItemSemanticEditPolicy.getLinkConstraints().canExistParallel_4003(container, getLink(), source,
				getNewTarget());
	}
	...
	* @generated
	*/
	protected Parallel getLink() {
		return (Parallel) getElementToEdit();
	}
