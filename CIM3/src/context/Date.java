...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Date</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see context.ContextPackage#getDate()
 * @model
 * @generated
 */
public enum Date implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Date</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Date[] VALUES_ARRAY =
		new Date[] {
			SECOND,
			MINUTE,
			HOUR,
	...
	/**
	 * A public read-only list of all the '<em><b>Date</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Date> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Date</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Date get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Date result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Date</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static Date getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Date result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Date</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Date get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Date(int value, String name, String literal) {
		this.value = value;
		this.name = name;
