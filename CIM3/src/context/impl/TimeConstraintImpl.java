 ...
 * </p>
 * <ul>
 *   <li>{@link context.impl.TimeConstraintImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeConstraintImpl extends MinimalEObjectImpl.Container implements TimeConstraint {
	...
	protected EClass eStaticClass() {
		return ContextPackage.Literals.TIME_CONSTRAINT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ContextPackage.TIME_CONSTRAINT__NAME, oldName, name));
	}
